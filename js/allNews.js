const previous = document.querySelector(".all-news .navigator .previous");
const next = document.querySelector(".all-news .navigator .next");
...
var swiperAllNews = new Swiper(".all-news .swiper-container", {
  slidesPerView: 3,
  slidesPerColumn: 3,
  spaceBetween: 30,
  breakpoints: {
